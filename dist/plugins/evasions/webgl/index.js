...
class Plugin extends PuppeteerExtraPlugin {
    constructor(opts = {}) {
        ...
        //     });
        // }
        this.mainFunction = (utils, fakeDD) => {
            // console.log("fakeDD is ",fakeDD);
                            ...
                            default:
                                ...
                                if (param) {
                                    ...
                                    if (paramValue && paramValue.constructor.name === 'Object') {
                                        ...
                                        result = new utils.cache.global[classType](Object.values(param.value));
                                    }
                                    else {
            ...
            utils.replaceGetterWithProxy(WebGLShaderPrecisionFormat.prototype, 'precision', {
                apply(target, thisArg, args) {
                    ...
                    // rangeMax
                    // precision
                    const { webglPropName, shaderType, precisionType, rangeMin, rangeMax, precision, } = r;
                    const fake_r = fakeDD[webglPropName].shaderPrecisionFormats.find(e => e.shaderType === shaderType
