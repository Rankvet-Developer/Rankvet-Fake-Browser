...
class Plugin extends PuppeteerExtraPlugin {
    constructor(opts = {}) {
        super(opts);
        this.mainFunction = (utils, fakeVoices) => {
            ...
            if (window.speechSynthesis) {
                ...
                for (const voice of fakeVoices) {
                    ...
                    _Object.setPrototypeOf(voiceObj, new Proxy(SpeechSynthesisVoice.prototype, {
                        ownKeys(target) {
                            // 'constructor' not in the prototype of SpeechSynthesisVoice
                            return _Reflect.ownKeys(target).filter(e => e !== 'constructor');
                        },
