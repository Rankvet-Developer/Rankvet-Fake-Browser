...
class Plugin extends PuppeteerExtraPlugin {
    constructor(opts = {}) {
        super(opts);
        this.mainFunction = (utils, { internalHttpServerPort, browserUUID }) => {
            ...
            if ('undefined' !== typeof SharedWorker) {
                ...
                const sharedWorkerConstructor = Object.getOwnPropertyDescriptor(_SharedWorker.prototype, 'constructor');
