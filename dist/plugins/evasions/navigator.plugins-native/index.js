...
class Plugin extends PuppeteerExtraPlugin {
    constructor(opts = {}) {
        super(opts);
        this.mainFunction = (utils, { chromeMajorVersion, fakePlugins }) => {
            ...
            const pluginsData = chromeMajorVersion > 93
            ...
            for (const pluginData of pluginsData.plugins) {
                const { name, filename, description, __mimeTypes, } = pluginData;
            ...
            for (const mimeTypeData of pluginsData.mimeTypes) {
                const { type, suffixes, description, __pluginName, } = mimeTypeData;
