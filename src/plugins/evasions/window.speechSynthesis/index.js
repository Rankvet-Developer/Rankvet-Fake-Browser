        ...
        if (window.speechSynthesis) {
            ...
            for (const voice of fakeVoices) {
                ...
                _Object.setPrototypeOf(
                    voiceObj,
                    new Proxy(SpeechSynthesisVoice.prototype, {
                        ownKeys(target) {
                ...
                utils.mockGetterWithProxy(
                    ...
                    },
                    {
                        apply: (target, thisArg, args) => {
                            if (
                                voiceObjs
                                    .map((e) => _Object.getPrototypeOf(e))
                                    .includes(thisArg)
                            ) {
                            ...
                            return fakeVoices[voiceObjs.indexOf(thisArg)][
                                prop
                            ];
                        },
                    },
