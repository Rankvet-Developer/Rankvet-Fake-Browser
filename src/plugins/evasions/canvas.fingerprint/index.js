...
class Plugin extends PuppeteerExtraPlugin {
    ...
    mainFunction = (utils, canvasSalt) => {
        ...
        let _OffscreenCanvasRenderingContext2D_prototype_getImageData =
            null;
        ...
        if ('undefined' !== typeof OffscreenCanvas) {
            ...
            _OffscreenCanvas_prototype_getContext =
                OffscreenCanvas.prototype.getContext;
            _OffscreenCanvasRenderingContext2D_prototype_getImageData =
        ...
        if ('undefined' !== typeof WebGLRenderingContext) {
            _WebGLRenderingContext_prototype_readPixels =
                WebGLRenderingContext.prototype.readPixels;
        }

        if ('undefined' !== typeof WebGL2RenderingContext) {
            _WebGL2RenderingContext_prototype_readPixels =
        ...
        const getContextImageUint8Data = (context) => {
            ...
            if (
                ...
                result =
                    _CanvasRenderingContext2D_prototype_getImageData.call(
                        context,
                        0,
                        0,
                ...
                // OffscreenCanvasRenderingContext2D
                result =
                    _OffscreenCanvasRenderingContext2D_prototype_getImageData.call(
                        context,
                        0,
                        0,
                        context.canvas.width,
        ...
        for (const {
            ...
            const getNoisifyCanvas = (canvas) => {
                const { context: originalContext, contextIndex } =
                ...
                const context =
                    utils.variables.renderingContextWithOperators[
                        contextIndex
                    ];
                ...
                let newContext =
                    ...
                    ('undefined' !== typeof OffscreenCanvas &&
                        OffscreenCanvas.prototype)
                        ? _OffscreenCanvas_prototype_getContext.call(
                              canvasWithNoise,
                              '2d',
                          )
                        : _HTMLCanvasElement_prototype_getContext.call(
                              canvasWithNoise,
                              '2d',
                          );

                // Get the original ImageData
                const imageUint8DataOriginal =
                    getContextImageUint8Data(originalContext);
                const imageUint8Data = Uint8ClampedArray.from(
                    imageUint8DataOriginal,
                );
                ...
                for (let y = 0; y < canvasHeight - 1; y += 2) {
                    for (let x = 0; x < canvasWidth - 1; x += 2) {
                        ...
                        // bottom right
                        // 4 pixel points
                        const p00 = imageUint8DataOriginal[pos],
                            p01 = imageUint8DataOriginal[pos + 1];
                        const p10 =
                                imageUint8DataOriginal[pos + canvasWidth],
                            p11 =
                                imageUint8DataOriginal[
                                    pos + canvasWidth + 1
                                ];
                ...
                'getImageData',
                {
                    apply(target, thisArg, args) {
                        ...
                        if (contextIndex >= 0) {
                            ...
                            const newCanvas = getNoisifyCanvas(
                                thisArg.canvas,
                            );
                            context = _Canvas_prototype_getContext.call(
                                newCanvas,
                                '2d',
                            );
                        }
