...
class Plugin extends PuppeteerExtraPlugin {
    ...
    mainFunction = (
        ...
        fakeNavigator.userAgent = fakeNavigator.userAgent.replace(
            fakeVersion,
            realVersion,
        );

        if (fakeNavigator.appVersion) {
            fakeNavigator.appVersion = fakeNavigator.appVersion.replace(
                fakeVersion,
                realVersion,
            );
        }
        ...
        const overwriteObjectProperties = function (
            obj,
            newPropValues,
            blackList,
        ) {
        ...
        if ('undefined' !== typeof window) {
            overwriteObjectProperties(window, fakeWindow, [
                'pageXOffset',
                'pageYOffset',
            ]);
        }
