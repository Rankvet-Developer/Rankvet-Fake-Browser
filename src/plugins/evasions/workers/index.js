            ...
            utils.replaceWithProxy(utils.cache.global, 'Worker', {
                construct: function (target, args) {
                    ...
                    for (;;) {
                        ...
                        args[0] = `http://127.0.0.1:${internalHttpServerPort}/patchWorker?type=worker&uuid=${browserUUID}&relUrl=${encodeURIComponent(
                            relUrl,
                        )}&workerUrl=${encodeURIComponent(workerUrl)}`;
            ...
            utils.replaceWithProxy(utils.cache.global, 'SharedWorker', {
                construct: function (target, args) {
                    ...
                    for (;;) {
                        ...
                        args[0] = `http://127.0.0.1:${internalHttpServerPort}/patchWorker?type=sharedWorker&uuid=${browserUUID}&relUrl=${encodeURIComponent(
                            relUrl,
                        )}&workerUrl=${encodeURIComponent(workerUrl)}`;
