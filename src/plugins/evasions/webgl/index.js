                ...
                'getParameter',
                {
                    apply(target, thisArg, args) {
                        ...
                        switch (type) {
                            ...
                            default:
                                const param =
                                    fakeDD[fakeDDPropName].params[type];
            ...
            utils.replaceWithProxy(
                ...
                'getContextAttributes',
                {
                    apply(target, thisArg, args) {
                        ...
                        result.alpha =
                            fakeDD[fakeDDPropName].contextAttributes.alpha;
                        result.antialias =
                            fakeDD[
                                fakeDDPropName
                            ].contextAttributes.antialias;
                        result.depth =
                            fakeDD[fakeDDPropName].contextAttributes.depth;
