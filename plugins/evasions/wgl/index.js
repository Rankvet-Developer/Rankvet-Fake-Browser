...
class Plugin extends PuppeteerExtraPlugin {
  ...
  async onPageCreated(page) {
    await withUtils(this,page).evaluateOnNewDocument((utils, opts) => {
      const getParameterProxyHandler = {
        apply: function(target, ctx, args) {
          ...
          // UNMASKED_RENDERER_WEBGL
            ...
            return opts.renderer || "ANGLE (Intel, Vulkan 1.2.182 (Intel(R) UHD Graphics 630 (CML GT2) (0x00009BC8)), Intel open-source Mesa driver)" // default in headless: Google SwiftShader
          }
        //   else {
